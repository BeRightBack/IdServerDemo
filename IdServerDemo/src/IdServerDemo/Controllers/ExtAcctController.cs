...
{
    public class ExtAcctController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var code = await _userManager.GenerateEmailConfirmationTokenAsync(user);
                    var callbackUrl = Url.Action("ConfirmEmail", "ExtAcct", new { userId = user.Id, code = code , returnUrl}, protocol: HttpContext.Request.Scheme);
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction(nameof(ExtAcctController.ResetPasswordConfirmation), "Account");
            }
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                await _emailSender.SendEmailAsync(await _userManager.GetEmailAsync(user), Startup.Configuration["SmtpUser"], "Security Code", message);
            }
